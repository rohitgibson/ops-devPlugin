...
__plugin_package__ = "devplugin"
__plugin_name__ = "Dev Test"
__plugin_version__ = "2022-01-D1"
__plugin_description__ = "Added: (1) method for establishing connection, (2) framework for maintaining connection"
